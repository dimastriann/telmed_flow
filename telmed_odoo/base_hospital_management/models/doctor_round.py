...
class DoctorRound(models.Model):
    ...
    admission_id = fields.Many2one(
        "hospital.inpatient", string="Patient", help="Choose the patient"
    )
    doctor_id = fields.Many2one(
        "hr.employee",
        domain=[("job_id.name", "=", "Doctor")],
        string="Doctor",
        help="Choose your doctor",
    )
    date = fields.Datetime(string="Visit Time", help="Choose the visit time of doctor")
