...
class HospitalBed(models.Model):
    ...
    name = fields.Char(
        string="Bed Number", help="Indicates the unique number for a bed", required=True
    )
    ...
    ward_id = fields.Many2one(
        "hospital.ward",
        string="Ward",
        help="Indicates the ward to which the bed belongs to",
    )
    room_id = fields.Many2one(
        "patient.room",
        string="Room",
        help="Indicates the room to which the bed belongs to",
    )
