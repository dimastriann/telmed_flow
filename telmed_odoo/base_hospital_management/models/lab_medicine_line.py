...
class LabMedicineLine(models.Model):
    ...
    test_id = fields.Many2one(
        "lab.test", string="Test", help="Test corresponds to medicine"
    )
    ...
    quantity = fields.Integer(string="Quantity", default=1, help="Quantity of medicine")
    ...
    price = fields.Float(
        string="Price", help="Price for the medicine", related="medicine_id.list_price"
    )
