...
class HospitalLaboratory(models.Model):
    ...
    image_130 = fields.Image(
        max_width=128, max_height=128, string="Image", help="Image of the laboratory"
    )
    phone = fields.Char(string="Phone", help="Phone number of laboratory")
    mobile = fields.Char(string="Mobile", help="Mobile number of laboratory")
    ...
    state_id = fields.Many2one("res.country.state", string="State", help="State of lab")
    ...
    technician_id = fields.Many2one(
        ...
        help="Name of the lab technician who has the in charge",
    )
    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            if vals.get("name", "New") == "New":
                vals["name"] = (
                    self.env["ir.sequence"].next_by_code("laboratory.sequence") or "New"
                )
